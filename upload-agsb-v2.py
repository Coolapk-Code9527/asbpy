...
# ====== 全局可配置参数（可直接在此处修改） ======
USER_NAME = "code9527"         # 用户名
UUID = "6b19a32a-402e-4b0b-8226-0b4fe26d3c80"                     # UUID，留空则自动生成
PORT = 9528                   # Vmess端口，留空或0则自动生成
DOMAIN = "idx.code9527.dpdns.org"                   # 域名，留空则自动获取
CF_TOKEN = "eyJhIjoiNWE2NTEzY2Q5OWE3ZjRlOWMxYjQ1YWI5ODFjYmYxNWUiLCJ0IjoiNDlkOTUxYmUtODA2Zi00NGFiLWJhZDYtZWUwNTMwN2NhZWMxIiwicyI6IlpURmtOVGM1WlRNdFpqRTJZaTAwWkRBd0xXSmhOekV0T0RNM01XUXhaRE01WXpNMyJ9"                 # Cloudflare Token，留空则用Quick Tunnel
# =========================================
